...
%----plotting graphs-----
%plot(B, total_data)
plot(H,total_data_1,'k-+',H,total_data_2,'k-*',H,total_data_3,'k-o','LineWidth',0.6);
xlabel('Hovering Height of UAV (meters)')
